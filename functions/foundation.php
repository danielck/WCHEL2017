 ...
 */
add_action('wp_head', 'customizer_test_foundation_adminbar_styles');
function customizer_test_foundation_adminbar_styles() {
 ...
 */
add_filter( 'post_gallery', 'customizer_test_foundation_gallery_shortcode', 10, 2 );
function customizer_test_foundation_gallery_shortcode($defaults = '', $attr) {
	global $post;
 ...
 */
add_filter('embed_oembed_html', 'customizer_test_foundation_embed_oembed_html', 99, 4);
function customizer_test_foundation_embed_oembed_html( $html, $url, $attr, $post_id ) {
